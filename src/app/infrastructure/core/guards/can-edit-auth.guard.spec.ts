...
!environment.testUnit
  ...
  : describe('[Unit] CanEditAuthGuard', () => {
      let guard: CanEditAuthGuard;
      ...
      beforeEach(() => {
        ...
        injector = getTestBed();
        guard = injector.inject(CanEditAuthGuard);
      });
      ...
      describe('canActivate()', () => {
        ...
        it(`should redirect to the root '/' route when navigation fails due to non-editor role.`, () => {
        ...
        it('should return true for an Editor', () => {
          const mockUser$ = new BehaviorSubject<IUserDTO>(
            new UserDTO({
              firstName: 'Test',
              lastName: 'Tester',
        ...
        it('should return false for a non-editor user', () => {
          const mockUser$ = new BehaviorSubject<IUserDTO>(
            new UserDTO({
              firstName: 'Test',
              lastName: 'Tester',
