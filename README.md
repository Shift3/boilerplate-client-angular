...
- Update the `index.ts` file under i18n folder to export all language files.
- Update the _LANGUAGE_ enum in `enums.ts` to list all the supported languages against their codes.
